...
default: $(JSONH)
	...
	gcc client.c res/sha3.c res/base64.c client_packets.c -lenet -lsqlite3 $(LIB) $(INC) -o client -Wl,-rpath,/usr/local/lib/,-rpath,.
	gcc server.c res/sha3.c res/guid.c res/base64.c server_packets.c server_sql.c -lenet -lsqlite3 $(LIB) $(INC) -o server -Wl,-rpath,/usr/local/lib/,-rpath,.
